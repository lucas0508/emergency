...
import com.tjmedicine.emergency.ui.other.AndroidOPermissionActivity;
        ...
        if (completeDownLoadId == mReqId) {
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) { // 6.0以下
                ...
                uri = FileProvider.getUriForFile(context,
                        "com.tjmedicine.emergency",
                        new File(context.getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS), "121急救.apk"));
