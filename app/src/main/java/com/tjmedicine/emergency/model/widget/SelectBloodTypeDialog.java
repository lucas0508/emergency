 ...
 * desc   :选择性别弹出框
 */
public class SelectBloodTypeDialog extends Dialog {
    private static final String[] PLANETS = new String[]{"A型", "B型", "AB型", "O型", "未知"};
    private Context context;
    private SelectSexWheelView selSex;

    public SelectBloodTypeDialog(Context context) {
...
//                    sex = "0";
//                }
                selectSexListener.setSelectSex(seletedItem, "");
                dismiss();
            }
        });
